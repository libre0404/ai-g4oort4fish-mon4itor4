# 闲鱼(goofish)智能监控机器人
感谢作者提供的优质资源。本人只简单增加了一个插件，主要功劳还是原作者。

增加 playwright-stealth 带来的好处主要是：

降低一上来就被弹 baxia-dialog 或 J_MIDDLEWARE_FRAME_WIDGET 这类验证页的概率，让搜索页、详情页能尽量直接加载成功。​

让“少量频率不高的任务”跑得更稳定一些，比如定时监控新发布商品、抓卖家主页时不那么容易被直接挡掉。​
...
详情页间休息
共同构成“指纹伪装 + 行为节奏伪装”，整体比纯裸 Playwright 好得多
